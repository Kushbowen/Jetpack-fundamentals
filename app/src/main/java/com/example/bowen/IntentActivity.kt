...
fun MyIntents(){
    Column(
        modifier = Modifier
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.hypno),
                contentScale = ContentScale.FillBounds
            )) {

        val mContext = LocalContext.current
        TopAppBar(
            title = { Text(text = "Intents", color = Color.Black) },
        ...
        OutlinedButton(onClick = {
            ...
            smsIntent.data="smsto:0745625882".toUri()
        ...
        Spacer(modifier = Modifier.height(20.dp))
        Text(
            text = "Do you want to create an account?Sign Up",
            fontSize = 20.sp,
